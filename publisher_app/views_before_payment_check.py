        ...
        if aamarpay_payment == "5": 
            ...
            if not request.session.get('userid'):
                ...
                if not chk_customer: 
                    ...
                    pay = aamarPay(
                        isSandbox=True, storeID = str(storeID), successUrl = str(successUrl), cancelUrl= str(cancelUrl), failUrl= str(failUrl), 
                    ...
                    print("paymentpath: ", paymentpath)
                    print("status: ", paymentpath.status_code)
                    if paymentpath: 
