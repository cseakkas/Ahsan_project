    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_discount', models.CharField(default=0, max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('1', 'COD'), ('2', 'Bkash'), ('3', 'Rocket'), ('4', 'Nagad')], default=1, max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_number', models.IntegerField(default=0)),
                ('payment_method', models.CharField(choices=[('1', 'COD'), ('2', 'Bkash'), ('3', 'Rocket'), ('4', 'Nagad')], default=1, max_length=1)),
                ('payment_status', models.CharField(choices=[('1', 'Partial'), ('2', 'Pull'), ('3', 'Due'), ('4', 'Free')], default=1, max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('status', models.BooleanField(default=True)),
                ('category_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='publisher_app.MastarCategorySetup')),
            ],
            options={
